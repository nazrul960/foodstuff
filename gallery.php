                    ...
                    <div class="product-grid">
                        <ul>
                            <li>
                                <div class="products">
                                    <a href="#">
                                        <img src="images/apple.jpg" alt="" style="height:200px; width: 100%;">
                                    </a>
                                </div>  <!-- End of /.products -->
                            </li>
                            ...
                            <li>
                                <div class="products">
                                    <a href="#">
                                        <img src="images/orange.jpg" alt="" style="height:200px; width: 100%;">
                                    </a>
                                </div>  <!-- End of /.products -->
                            </li>
                            ...
                            <li>
                                <div class="products">
                                    <a href="#">
                                        <img src="images/avocado.jpg" alt="" style="height:200px; width: 100%;">
                                    </a>
                                </div>  <!-- End of /.products -->
                            </li>
                            ...
                            <li>
                                <div class="products">
                                    <a href="#">
                                        <img src="images/pomegranate.jpg" alt="" style="height:200px; width: 100%;">
                                    </a>
                                </div>  <!-- End of /.products -->
                            </li>
                        ...
                        <div class="block">
                            ...
                            <div class="list-group">
                                <a href="gallery.php" class="list-group-item">
                                    ...
                                    FRUIT GALLERY IMAGES
                                </a>
                                <a href="vegetable_gallery_images.php" class="list-group-item">
                                    <i class="fa  fa-dot-circle-o"></i>
                                    VEGETABLE GALLERY IMAGES
                                </a>
